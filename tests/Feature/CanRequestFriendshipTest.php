...
class CanRequestFriendshipTest extends TestCase
{
    ...
    /** @test */
    function senders_cannot_delete_deny_friendship_request()
    {
        $sender = factory(User::class)->create();
        $recipient = factory(User::class)->create();
    ...
    /** @test */
    function recipients_can_delete_deny_friendship_request()
    {
        $sender = factory(User::class)->create();
        $recipient = factory(User::class)->create();
    ...
    function guests_users_cannot_accept_friendship_request()
    {
        ...
        $this->postJson(route('accept-friendships.destroy', $sender))
            ->assertStatus(401);
